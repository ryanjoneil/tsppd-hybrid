...
int main(int argc, char** argv) {
    ...
    try {
        ...
        else if (solver_abbrev == "atsppd-oneil")
            solver = make_shared<ONeilATSPPDSolver>(problem, solver_options, writer);
        else if (solver_abbrev == "atsppd-oneil+")
            solver = make_shared<ONeilATSPPDPlusSolver>(problem, solver_options, writer);
