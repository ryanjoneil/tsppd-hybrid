...
#ifndef TSPPD_SOLVER_FOCACCI_CLOSEST_NEIGHBOR_DUAL_H
#define TSPPD_SOLVER_FOCACCI_CLOSEST_NEIGHBOR_DUAL_H
...
namespace TSPPD {
    namespace Solver {
        class FocacciClosestNeighborDual : public Gecode::Propagator {
        public:
            FocacciClosestNeighborDual(
                Gecode::Space& home,
