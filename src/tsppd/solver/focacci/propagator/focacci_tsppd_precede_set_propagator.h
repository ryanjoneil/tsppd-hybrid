...
#ifndef TSPPD_SOLVER_FOCACCI_TSPPD_PRECEDE_SET_PROPAGATOR_H
#define TSPPD_SOLVER_FOCACCI_TSPPD_PRECEDE_SET_PROPAGATOR_H
...
namespace TSPPD {
    namespace Solver {
        class FocacciTSPPDPrecedeSetPropagator : public Gecode::Propagator {
        public:
            FocacciTSPPDPrecedeSetPropagator(
                Gecode::Home home,
            ...
            FocacciTSPPDPrecedeSetPropagator(Gecode::Space& home, FocacciTSPPDPrecedeSetPropagator& p);
