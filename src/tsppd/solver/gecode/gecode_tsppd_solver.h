...
#ifndef TSPPD_SOLVER_GECODE_TSPPD_SOLVER_H
#define TSPPD_SOLVER_GECODE_TSPPD_SOLVER_H
...
namespace TSPPD {
    namespace Solver {
        class GecodeTSPPDSolver : public GecodeTSPSolver {
        public:
            GecodeTSPPDSolver(
        ...
        protected:
            ...
            virtual std::shared_ptr<GecodeTSPSpace> build_space() override;

            GecodeTSPPDPrecedePropagatorType precede_type;
            bool ap;
            bool omc;
       };
    }
