...
#ifndef TSPPD_SOLVER_GECODE_TSPPD_PRECEDE_COST_PROPAGATOR_H
#define TSPPD_SOLVER_GECODE_TSPPD_PRECEDE_COST_PROPAGATOR_H
...
namespace TSPPD {
    namespace Solver {
        class GecodeTSPPDPrecedeCostPropagator : public Gecode::Propagator {
        public:
            GecodeTSPPDPrecedeCostPropagator(
                Gecode::Home home,
