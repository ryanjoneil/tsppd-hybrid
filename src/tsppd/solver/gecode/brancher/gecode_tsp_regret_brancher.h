...
#ifndef TSPPD_SOLVER_GECODE_TSP_REGRET_BRANCHER_H
#define TSPPD_SOLVER_GECODE_TSP_REGRET_BRANCHER_H

#include <tsppd/solver/gecode/brancher/gecode_tsp_brancher.h>

namespace TSPPD {
    namespace Solver {
        class GecodeTSPRegretBrancher : public GecodeTSPBrancher {
        public:
            GecodeTSPRegretBrancher(
                Gecode::Home home,
